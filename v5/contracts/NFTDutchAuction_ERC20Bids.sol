...
contract NFTDutchAuction_ERC20Bids is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function submitBidWithPermit(uint256 bidAmount, PermitData memory permitData) external {
    ...
    function getPermitDigest(
        ...
        return keccak256(abi.encodePacked(owner, spender, value, deadline, nonce, address(this)));
    }
